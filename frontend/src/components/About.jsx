...
const SOURCES = [
  ...
  },
  {
    icon: Robot,
    name: "Mistral AI",
    desc: "Analisis sektoral, rekomendasi saham, dan sentimen berita menggunakan LLM Mistral AI tanpa fine-tuning.",
  },
  {
    icon: Sparkle,
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-muted">
                <ChartLineUp className="h-6 w-6 text-foreground" />
              </div>
              <div>
            ...
            <Card key={step.title} className="border-border bg-card">
              <CardContent className="flex gap-4 p-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs leading-6 text-muted-foreground">{step.desc}</p>
                </div>
              </CardContent>
            </Card>
          ))}
      ...
      <section>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          {SOURCES.map((source) => (
            <Card
              key={source.name}
              className="border-border bg-card transition-colors hover:border-muted-foreground/30"
            >
              <CardContent className="flex gap-4 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-muted-foreground">{source.desc}</p>
                </div>
              </CardContent>
            </Card>
          ))}
      ...
      <section>
        <div className="rounded-lg border border-border bg-muted/30 p-4 sm:p-5">
          <div className="flex items-start gap-3">
            <ShieldCheck className="mt-0.5 hidden h-5 w-5 shrink-0 text-muted-foreground sm:block" />
            <div className="min-w-0 space-y-2">
              <p className="text-xs font-semibold text-foreground sm:text-sm">Disclaimer</p>
              <p className="text-xs leading-6 text-muted-foreground sm:text-sm">
