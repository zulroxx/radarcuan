...
export default function MacroDashboard() {
      ...
      mengetat: {
        ...
        actions: {
          ...
          safety: {
            ...
            proteksi: "Pastikan asurasi kesehatan aktif. Cari sumber pendapatan tambahan (side hustle / freelance). Evaluasi ulang portofolio investasi setiap 1–2 bulan.",
          },
        },
      },
      stabil: {
        ...
        actions: {
          ...
          safety: {
            ...
            proteksi: "Pastikan asurasi jiwa & kesehatan sesuai tanggungan. Diversifikasi sumber pendapatan. Review portofolio setiap kuartal.",
          },
        },
      },
      lesu: {
        ...
        actions: {
          ...
          safety: {
            ...
            proteksi: "Pastikan asurasi jiwa & kesehatan tetap aktif (jangan ditunggak). Siapkan CV & portofolio untuk antisipasi PHK. Cari pendapatan alternatif (ojol, freelance, dagang kecil). Jual aset non-produktif untuk tambah kas.",
          },
        },
      },
    };
  ...
  const StatusBadgeIcon = ({ status }) => {
    if (status === "mengetat") return <WarningCircle className="h-4 w-4" weight="fill" />;
    if (status === "lesu") return <TrendDown className="h-4 w-4" weight="fill" />;
    return <ShieldCheck className="h-4 w-4" weight="fill" />;
  };
        ...
        <CardHeader className="border-b border-slate-200 p-4 sm:p-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Badge className={`ml-auto gap-1.5 px-3 py-1 text-xs font-semibold ${rpkContent.badge}`}>
              <StatusBadgeIcon status={macroStatus} />
              {rpkContent.label}
            </Badge>
          </div>
        </CardHeader>
          ...
          <div>
            ...
            <div className="mt-3 space-y-3">
              <div className="rounded-lg border border-sky-100 bg-sky-50 p-3">
                <p className="text-xs font-semibold text-sky-800">Kondisi Pasar Terkini</p>
                <p className="mt-1 text-xs leading-6 text-sky-700">
                  {rpkContent.situation.kondisi}
                </p>
              </div>
              <div className="rounded-lg border border-amber-100 bg-amber-50 p-3">
                <p className="text-xs font-semibold text-amber-800">Dampak Pada Dompet / Bisnis</p>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="rounded-md border border-red-100 bg-red-50 p-2.5">
                      <p className="flex items-center gap-1 text-[10px] font-semibold text-red-800">
  ...
  const statCards = useMemo(() => {
    ...
    return {
      ...
      positive,
      negative,
      avgChange: changeCount > 0 ? sumChange / changeCount : 0,
    };
  }, [indicators]);
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-sky-200 bg-sky-50 p-3 sm:p-4">
        <div className="flex items-start gap-3">
          <Coin className="mt-0.5 hidden h-5 w-5 shrink-0 text-sky-700 sm:block" />
          <div className="min-w-0 space-y-1">
            <p className="text-xs font-semibold text-sky-950 sm:text-sm">
              Disclaimer Makro Ekonomi
            </p>
            <p className="text-xs leading-6 text-sky-800 sm:text-sm">
