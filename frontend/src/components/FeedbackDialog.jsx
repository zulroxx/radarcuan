  ...
  return (
    <Dialog onOpenChange={setOpen} open={open}>
      <DialogTrigger asChild>
        <Button className="shrink-0 rounded-full border border-slate-200 bg-white px-3 text-xs font-medium text-slate-700 shadow-sm hover:bg-slate-50 hover:text-slate-900 sm:px-4 sm:text-sm dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 dark:hover:text-slate-50" data-testid="header-feedback-button" type="button" variant="outline">
          <ChatCircleDots className="h-3.5 w-3.5 sm:h-4 sm:w-4" weight="duotone" />
          <span className="hidden sm:inline">Feedback</span>
        </Button>
      </DialogTrigger>
      <DialogContent className="border-slate-200 bg-white sm:max-w-xl dark:border-slate-700 dark:bg-slate-900" data-testid="feedback-dialog">
        <DialogHeader className="text-left">
          <DialogTitle className="text-2xl text-slate-950 dark:text-slate-50">Bagikan feedback beta Anda</DialogTitle>
        ...
        <form autoComplete="on" className="space-y-4" onSubmit={handleSubmit}>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 dark:text-slate-200" data-testid="feedback-name-label">Nama</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 dark:text-slate-200" data-testid="feedback-email-label">Email</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700 dark:text-slate-200" data-testid="feedback-message-label">Feedback</label>
