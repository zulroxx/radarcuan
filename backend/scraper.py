...
def main():
    try:
        ...
        _scraper_tz_cache = Path(__file__).parent / "agent_cache" / "yfinance_tz"
        _scraper_tz_cache.mkdir(parents=True, exist_ok=True)
        yf.set_tz_cache_location(str(_scraper_tz_cache))
    except ImportError:
